...
> Updated **2026-08-06** — PACK-006 **COMPLETE**; PACK-007 Part 1 done; scope + FR-007-08/09/10; FU-AI-001 / FU-SEC open
...
| TASK-026 | REQ-ROUTE-KM | Must | 74 | PACK-007: predefined routes + Maps handling + km comparison | Architect→Builder | **In progress** (Part 1 done) | Corridor choice; Maps; paid vs calculated vs direct km; cache; manual overrides | `sprints/sprint-007/` · `751c978` |
| TASK-034 | REQ-ROUTE-KM / FR-007-08 | Must | 72 | Implement manual Google Maps link input | Builder | **NOT_STARTED** — HIGH | Dispatcher override `manual_route_url`; viewer read-only; audit log; ~0.5 days | Depends on PACK-007 Part 2 (KM delta) |
| TASK-035 | REQ-ROUTE-KM / FR-007-09 | Must | 72 | Implement manual KM input | Builder | **NOT_STARTED** — HIGH | Manual paid_km / actual_km; source=manual; viewer read-only; audit; ~0.5 days | Depends on PACK-007 Part 2 (KM delta) |
...
- PACK-007: Part 1 **IMPLEMENTED** (`751c978`); scope expanded FR-007-08/09/10; TASK-034…036 queued. PACK-008: **NOT_STARTED** (PDF/Excel export).
